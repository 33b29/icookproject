...
public class ProductController {
	...
	public String createNewProduct(Model model, HttpServletRequest req,
		...
		String imgLink = "";
		String allImg = "";
		String[] urlArray = new String[]{"https://imgur.com/nqtYDCm.jpg","https://imgur.com/7NB4fs1.jpg","https://imgur.com/SW1gBxV.jpg"};
			...
			try {
				for (MultipartFile image : image1) {
					...
					if (image.isEmpty() == false) {
						...
						} else if(count < urlArray.length){
							// 塞找不到圖片的的圖檔
//							imgLink = "https://imgur.com/fUNhU08.jpg";
							//寫死傳送的檔案:
							imgLink = urlArray[count];
