...
<!--                     </div> -->
                    ...
                    <div>
                      <input type="submit" class="btn btn-primary btn-user btn-block" style="margin-top: 50px;" value="Login">
						<div class="dropdown">
                      <button type="button" class="btn btn-primary btn-user btn-block dropdown-toggle" style="margin-top: 15px; margin-bottom:40px;" data-toggle="dropdown">切換使用者
    					<span class="caret"></span></button>
    					<ul class="dropdown-menu dropdown-menu-right">
      						<li><a onclick="adminAcc()">最高權限</a></li>
      						<li><a onclick="productAcc()">產品管理員</a></li>
      						<li><a onclick="webAcc()">網站管理員</a></li>
    					</ul>
  						</div>
                    </div>
<!--                     <div> -->
