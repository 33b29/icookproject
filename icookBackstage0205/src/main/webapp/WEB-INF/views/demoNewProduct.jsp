					...
					<div class='card card-success'>
						...
						<div class="card-body">
							<form role="form" id='formProduct' action="createNewProduct" method="post" enctype="multipart/form-data">
										...
										<td style=" width: 200px;padding-right: 50px;">
											<div class='form-group'>
												...
												<select class='form-control' id='category' name="category">
													<option id='option1' value='肉類'>肉類</option>
													<option id='option2' value='鍋具'>鍋具</option>
													<option id='option3' value='菜類'>菜類</option>
													<option id='option4' value='咖啡'>咖啡</option>
													<option id='option5' value='家電'>家電</option>
													<option id='option6' value='麵包'>麵包</option>
													<option id='option7' value='乾貨'>乾貨</option>
													<option id='option8' value='餐廚'>餐廚</option>
													<option id='option9' value='食品'>食品</option>
												</select>
											</div>
										</td>
									</tr>
									...
									<table>
										<tr>
											<td style='width: 500px; padding-right: 50px;'>
												<div class='form-group'>
													<label>商品規格</label>
													<input type='text' class='form-control' id='typeTitle0' name="typeTitle">
												</div>
											</td>
											<td style='width: 200px; padding-right: 50px;'>
												<div class='form-group'>
													<label>售價</label>
													<input type='text' class='form-control' id='unitPrice0' name="unitPrice">
												</div>
											</td>
											<td style='width: 200px;  padding-right: 50px;' >
												<div class='form-group'>
													<label>庫存</label>
													<input type='text' class='form-control' id='unitStock0' name='unitStock'>
												</div>
											</td>
								...
								<div style='width: 100%;' align='left' valign="middle" id="addButton">
									<input  style='padding:0px; width: 20%;' type='button' class='btn btn-primary  btn-lg btn-block' 
